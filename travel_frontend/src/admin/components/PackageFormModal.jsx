          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none transition ${errors.title ? 'border-red-500' : 'border-gray-300'
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none ${errors.duration ? 'border-red-500' : 'border-gray-300'
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none ${errors.price ? 'border-red-500' : 'border-gray-300'
                  }`}
              />
            ...
            <div className="md:col-span-2">
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none ${errors.country ? 'border-red-500' : 'border-gray-300'
                  }`}
              >
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 ${errors.image ? 'border-red-500' : 'border-gray-300'
                    }`}
                />
              </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows="4"
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none resize-none ${errors.description ? 'border-red-500' : 'border-gray-300'
                  }`}
              />
